...
program tb_vga_controller ();
    ...
    `TB_TEST_PART("display_active region")
        ...
        @(posedge TB.clk);
        `Check(TB.dut0.de0.vga0.display_active == 1'b0, ("display_active should be 0 in front-porch"))
        release TB.dut0.de0.vga0.Hcnt;
        release TB.dut0.de0.vga0.Vcnt;
        repeat(4) @(posedge TB.clk);

        // Should be active: first active pixel
        force TB.dut0.de0.vga0.Hcnt = H_ACTIVE_START;
        force TB.dut0.de0.vga0.Vcnt = V_ACTIVE_START;
        @(posedge TB.clk);
        `Check(TB.dut0.de0.vga0.display_active == 1'b1, ("display_active should be 1 at first active pixel"))
        release TB.dut0.de0.vga0.Hcnt;
        release TB.dut0.de0.vga0.Vcnt;
        repeat(4) @(posedge TB.clk);

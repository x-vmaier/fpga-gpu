...
#   vivado -mode batch -source create.tcl -tclargs --origin_dir <path>
#   vivado -mode batch -source create.tcl -tclargs --project_name <name>
#   vivado -mode batch -source create.tcl -tclargs --help
...
proc print_help {} {
    ...
    puts "  --project_name <name>   Override project name. Defaults to 'build'."
...
set_property -dict [list \
    ...
    CONFIG.Algorithm {Minimum_Area}] [get_ips blk_mem_gen_0]
